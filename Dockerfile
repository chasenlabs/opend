...
ARG BUILD_OPEND_VERSION=9.4.5408
ARG OPEND_DIR=/opend
ARG BIN_NAME=OpenD
...
# xxxx_OpenD_9.4.5408_Ubuntu16.04.tar.gz
ARG OPEND_PREFIX=${BRAND}_OpenD_${BUILD_OPEND_VERSION}_Ubuntu16.04
ARG OPEND_FILE=${OPEND_PREFIX}.tar.gz

# Download OpenD package
# https://softwaredownload.futunn.com/Futu_OpenD_9.4.5408_Ubuntu16.04.tar.gz
# https://softwaredownload.futustatic.com/moomoo_OpenD_9.4.5408_Ubuntu16.04.tar.gz
