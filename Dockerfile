...
ARG BUILD_OPEND_VERSION=8.7.4708
ARG OPEND_DIR=/opend
ARG BIN_NAME=OpenD
...
# xxxx_OpenD_8.7.4708_Ubuntu16.04.tar.gz
ARG OPEND_PREFIX=${BRAND}_OpenD_${BUILD_OPEND_VERSION}_Ubuntu16.04
ARG OPEND_FILE=${OPEND_PREFIX}.tar.gz

# Download OpenD package
# https://softwaredownload.futunn.com/Futu_OpenD_8.7.4708_Ubuntu16.04.tar.gz
# https://softwaredownload.futustatic.com/moomoo_OpenD_8.7.4708_Ubuntu16.04.tar.gz
